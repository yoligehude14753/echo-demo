...
{
  "goal": "用户真正要达成的目标",
  "execution_target": "builtin_skill | claude_code_runtime | conversational_response | clarification",
...
- 只有纯问答、寒暄或不需要工具/产物的对话才选择 conversational_response。
...
- execution_authorized=true 仅当没有 missing_constraints、没有 clarification_questions、
  且用户已明确授权执行时成立；对不触发工具或产物的 conversational_response，
  用户提出正常问答即视为授权继续对话。
"""
