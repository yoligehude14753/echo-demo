...
async def create_task(
    ...
    # This is the authoritative API-side check. The legacy runner receives a
    # task only after the same strict V4 Flash plan selects claude_code_runtime;
    # there is intentionally no implicit local runner fallback.
    ...
    # the renderer. The configured runner receives only this validated plan so
    # its task retains the selected context, steps and constraints.
