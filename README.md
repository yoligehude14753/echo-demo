...
> **当前版本**：v0.2.6（详见 [`CHANGELOG.md`](CHANGELOG.md)）
> **立即下载**：见 [GitHub Releases v0.2.6](https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.6)
...
当前 public demo 版本是 `v0.2.6`，安装包统一放在：
<https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.6>
...
| Android TV / 智能电视 | `EchoDesk-0.2.6-smart-tv.apk` | 适配遥控器、电视桌面入口和开机自启 |
...
| Phase 3 (0.2.6) | 首次启动引导 + 远端 endpoint 配置 + 知识库面板 + 智能电视一键安装/自启 + 会后扫码保存 + public demo backend | ✅ demo hotfix |
| Phase 4 | Keychain 集成 + 自动更新 + Universal Binary | 计划中 |

测试：backend 478 unit 通过；desktop 27 e2e + 24 scenarios 通过；CI backend lint/typecheck/unit + desktop e2e 全绿。
