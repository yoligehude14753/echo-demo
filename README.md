...
> **当前版本**：v0.2.30（详见 [`CHANGELOG.md`](CHANGELOG.md)）
> **立即下载**：见 [GitHub Releases v0.2.30](https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.30)
...
当前 public demo 版本是 `v0.2.30`，安装包统一放在：
...
| Android TV / 智能电视 | `EchoDesk-0.2.30-smart-tv.apk` | 适配遥控器、电视桌面入口和开机自启 |
...
| Phase 3 (0.2.30) | 首次启动引导 + 远端 endpoint 配置 + 知识库面板 + 智能电视一键安装/自启 + 会后扫码保存 + public demo backend + 检查更新 | ✅ demo hotfix |
