...
> **当前版本**：v0.2.7（详见 [`CHANGELOG.md`](CHANGELOG.md)）
> **立即下载**：见 [GitHub Releases v0.2.7](https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.7)
...
当前 public demo 版本是 `v0.2.7`，安装包统一放在：
<https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.7>
...
| Android TV / 智能电视 | `EchoDesk-0.2.7-smart-tv.apk` | 适配遥控器、电视桌面入口和开机自启 |
...
| Phase 3 (0.2.7) | 首次启动引导 + 远端 endpoint 配置 + 知识库面板 + 智能电视一键安装/自启 + 会后扫码保存 + public demo backend | ✅ demo hotfix |
| Phase 4 | Keychain 集成 + 自动更新 + Universal Binary | 计划中 |

测试：本地 backend 相关 unit 通过；desktop typecheck/lint/build 通过；28 个 e2e 模拟点击全绿；macOS / Windows / Android / TV release 产物已构建。
