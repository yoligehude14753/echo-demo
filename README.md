...
- Desktop：Electron main-process contracts `176 / 176 passed`；Playwright E2E `150 passed`；业务 scenarios `29 passed`。
- Public isolation：self-test 与双 principal 完整 smoke 均通过；release aggregate `28 / 28 passed`，actionlint 与 action pin 检查通过。
