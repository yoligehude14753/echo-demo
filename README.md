...
> **当前版本**：v0.2.35（详见 [`CHANGELOG.md`](CHANGELOG.md)）
> **立即下载**：见 [GitHub Releases v0.2.35](https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.35)
...
| Android TV / 智能电视 | `EchoDesk-0.2.35-smart-tv.apk` | 适配遥控器、电视桌面入口和开机自启 |
...
Windows 机器若出现 Device Guard / 组织策略拦截 `.exe` 安装器，请下载 `EchoDesk-0.2.35-win-x64.zip`，
...
测试：本地服务 WS unit 通过；desktop typecheck/lint/build 通过；TV / 分享 / 工作区 / 设置相关 e2e 模拟点击通过；macOS / Windows / Linux / Android / TV release 产物已构建。
