...
当前版本：`v0.2.6`  
下载页：<https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.6>

| 平台 | 直接下载 | 说明 |
|---|---|---|
| macOS Apple Silicon | `EchoDesk-0.2.6-arm64.dmg` | 桌面版安装包 |
| macOS 备用 zip | `EchoDesk-0.2.6-arm64-mac.zip` | dmg 打不开时使用 |
| Windows | `EchoDesk.Setup.0.2.6.exe` | Windows 安装包 |
| Android 手机 / 平板 | `EchoDesk-0.2.6-android.apk` | 默认连接公网 demo backend |
| Android TV / 智能电视 | `EchoDesk-0.2.6-smart-tv.apk` | 适配遥控器和电视桌面入口 |
| 智能电视一键安装 | `EchoDesk-0.2.6-smart-tv-oneclick.zip` | 内含 macOS / Windows ADB 安装脚本 |
| 校验文件 | `SHA256SUMS-0.2.6.txt` | 校验下载完整性 |
...
- macOS: `EchoDesk-0.2.6-arm64.dmg`
- Windows: `EchoDesk.Setup.0.2.6.exe`
- Android / Android TV: `EchoDesk-0.2.6-smart-tv.apk`（demo 包）
- 智能电视一键安装包：`EchoDesk-0.2.6-smart-tv-oneclick.zip`
...
```text
desktop/release/EchoDesk-0.2.6-arm64.dmg
desktop/release/EchoDesk-0.2.6-arm64-mac.zip
...
desktop/release/EchoDesk-0.2.6-android-tv-debug.apk
desktop/release/EchoDesk-0.2.6-smart-tv.apk
desktop/release/EchoDesk-0.2.6-smart-tv-oneclick.zip
```
...
国产 Android 或 AOSP TV，可以直接安装 `EchoDesk-0.2.6-smart-tv.apk`。

推荐路径：

1. 下载 `EchoDesk-0.2.6-smart-tv-oneclick.zip`。
