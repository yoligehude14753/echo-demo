...
当前版本：`v0.2.30`
下载页：<https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.30>
...
| Android TV / 智能电视 | `EchoDesk-0.2.30-smart-tv.apk` | 适配遥控器和电视桌面入口 |
| 智能电视一键安装 | `EchoDesk-0.2.30-smart-tv-oneclick.zip` | 内含 macOS / Windows ADB 安装脚本 |
...
```text
desktop/release/EchoDesk-0.2.30-arm64.dmg
desktop/release/EchoDesk-0.2.30-arm64-mac.zip
...
```text
desktop/release/EchoDesk-0.2.30.AppImage
desktop/release/echodesk-desktop_0.2.30_amd64.deb
```
...
desktop/release/EchoDesk-0.2.30-android.apk
desktop/release/EchoDesk-0.2.30-android-tv.apk
desktop/release/EchoDesk-0.2.30-smart-tv.apk
desktop/release/EchoDesk-0.2.30-smart-tv-oneclick.zip
```
...
国产 Android 或 AOSP TV，可以直接安装 `EchoDesk-0.2.30-smart-tv.apk`。

推荐路径：

1. 下载 `EchoDesk-0.2.30-smart-tv-oneclick.zip`。
