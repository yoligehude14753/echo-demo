...
当前版本：`v0.2.13`
下载页：<https://github.com/yoligehude14753/echo-demo/releases/tag/v0.2.13>
...
| Android TV / 智能电视 | `EchoDesk-0.2.13-smart-tv.apk` | 适配遥控器和电视桌面入口 |
...
应用内也可以在「设置 → 更新」里主动检查 GitHub Release。桌面端从 `0.2.13`
...
- macOS: `EchoDesk-0.2.13-arm64.dmg`
- Windows: `EchoDesk.Setup.0.2.13.exe`
- Linux: `EchoDesk-0.2.13.AppImage` 或 `echodesk-desktop_0.2.13_amd64.deb`
- Android 手机 / 平板: `EchoDesk-0.2.13-android.apk`（demo 包）
- Android TV / 智能电视: `EchoDesk-0.2.13-smart-tv.apk`
- 智能电视一键安装包：`EchoDesk-0.2.13-smart-tv-oneclick.zip`
...
```text
desktop/release/EchoDesk-0.2.13-arm64.dmg
desktop/release/EchoDesk-0.2.13-arm64-mac.zip
...
```text
desktop/release/EchoDesk-0.2.13.AppImage
desktop/release/echodesk-desktop_0.2.13_amd64.deb
```
...
desktop/release/EchoDesk-0.2.13-android-tv-debug.apk
desktop/release/EchoDesk-0.2.13-smart-tv.apk
desktop/release/EchoDesk-0.2.13-smart-tv-oneclick.zip
```
...
国产 Android 或 AOSP TV，可以直接安装 `EchoDesk-0.2.13-smart-tv.apk`。

推荐路径：

1. 下载 `EchoDesk-0.2.13-smart-tv-oneclick.zip`。
